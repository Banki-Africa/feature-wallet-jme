 ...
 * banki.util.logging.MemoryHandler.push.
 * <p>
 ...
 * <ul>
 * <li>banki.util.logging.MemoryHandler.filter specifies the {@code Filter}
 * class name, defaults to no {@code Filter}.</li>
 * <li>banki.util.logging.MemoryHandler.level specifies the level for this
 * {@code Handler}, defaults to {@code Level.ALL}.</li>
 * <li>banki.util.logging.MemoryHandler.push specifies the push level, defaults
 * to level.SEVERE.</li>
 * <li>banki.util.logging.MemoryHandler.size specifies the buffer size in number
 * of {@code LogRecord}, defaults to 1000.</li>
 * <li>banki.util.logging.MemoryHandler.target specifies the class of the target
...
public class MemoryHandler extends Handler {
    ...
    public MemoryHandler() {
        ...
        initProperties("ALL", null, "banki.util.logging.SimpleFormatter", null);
