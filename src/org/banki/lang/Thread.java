...
public class Thread implements Runnable {
     ...
     *
     * @see banki.lang.ThreadGroup
     * @see banki.lang.Runnable
     */
    public Thread() {
     ...
     * @param runnable a banki.lang.Runnable whose method <code>run</code> will
     ...
     * {@link banki.nio.channels.InterruptibleChannel} will have their interrupt
     * status set and receive an
     * {@link banki.nio.channels.ClosedByInterruptException}. Also, the channel
     * will be closed.
     * <li>
     * {@code Thread}s blocked in a {@link banki.nio.channels.Selector} will have
     ...
     * parent thread group's {@link banki.lang.ThreadGroup#getMaxPriority}, the group's maximum
     ...
     *
     * <p>See {@link banki.util.concurrent.locks.LockSupport} for more
