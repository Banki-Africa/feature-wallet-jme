 ...
 * invalid value.
 * <li>banki.util.logging.ConsoleHandler.filter specifies the name of the filter
 * class to be associated with this handler, defaults to {@code null} if this
 * property is not found or has an invalid value.
 * <li>banki.util.logging.ConsoleHandler.formatter specifies the name of the
 * formatter class to be associated with this handler, defaults to
 * {@code banki.util.logging.SimpleFormatter} if this property is not found or
 * has an invalid value.
 * <li>banki.util.logging.ConsoleHandler.encoding specifies the encoding this
