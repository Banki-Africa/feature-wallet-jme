...
public abstract class Pack200 {
    ...
    private static final String SYSTEM_PROPERTY_PACKER = "banki.util.jar.Pack200.Packer";

    private static final String SYSTEM_PROPERTY_UNPACKER = "banki.util.jar.Pack200.Unpacker";
     ...
     * {@code 'banki.util.jar.Pack200.Packer'}. If this system property is
     ...
     * property {@code 'banki.util.jar.Pack200.Unpacker'}. If this system
