...
import banki.nio.channels.AsynchronousCloseException;
import banki.nio.channels.Channel;
import banki.nio.channels.ClosedByInterruptException;
import banki.nio.channels.InterruptibleChannel;
...
public abstract class AbstractInterruptibleChannel implements Channel, InterruptibleChannel {
     ...
     * {@link banki.nio.channels.ClosedChannelException} is thrown.
     * <p>
     ...
     * @see banki.nio.channels.Channel#close()
     */
