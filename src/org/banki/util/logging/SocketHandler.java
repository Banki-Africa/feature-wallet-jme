...
import banki.io.BufferedOutputStream;
 ...
 * initialize itself:
 * <ul>
 * <li>banki.util.logging.ConsoleHandler.level specifies the logging level,
 * defaults to {@code Level.ALL} if this property is not found or has an invalid
 * value.
 * <li>banki.util.logging.SocketHandler.filter specifies the name of the filter
 * class to be associated with this handler, defaults to {@code null} if this
 * property is not found or has an invalid value.
 * <li>banki.util.logging.SocketHandler.formatter specifies the name of the
 * formatter class to be associated with this handler, defaults to
 * {@code banki.util.logging.XMLFormatter} if this property is not found or has
 * an invalid value.
 * <li>banki.util.logging.SocketHandler.encoding specifies the encoding this
 * handler will use to encode log messages, defaults to {@code null} if this
 * property is not found or has an invalid value.
 * <li>banki.util.logging.SocketHandler.host specifies the name of the host that
 * this handler should connect to. There's no default value for this property.
 * <li>banki.util.logging.SocketHandler.encoding specifies the port number that
 * this handler should connect to. There's no default value for this property.
 * </ul>
 * <p>
...
public class SocketHandler extends StreamHandler {
    ...
    // default formatter
    private static final String DEFAULT_FORMATTER = "banki.util.logging.XMLFormatter";
    ...
    public SocketHandler() throws IOException {
        ...
        initSocket(LogManager.getLogManager().getProperty(
                "banki.util.logging.SocketHandler.host"), LogManager
                .getLogManager().getProperty(
                        "banki.util.logging.SocketHandler.port"));
    }
