...
import banki.nio.charset.Charset;
import banki.nio.charset.Charsets;
import banki.util.Arrays;
import banki.util.Comparator;
import banki.util.Formatter;
import banki.util.Locale;
import banki.util.regex.Pattern;
...
public final class String implements Serializable, Comparable<String>, CharSequence {
     ...
     * {@link banki.nio.charset.Charset#defaultCharset default charset}.
     */
     ...
     * is unspecified. Use {@link banki.nio.charset.CharsetDecoder} for more control.
     *
     * @throws NullPointerException
     *             if {@code data == null}.
     * @throws IndexOutOfBoundsException
     ...
     * replacement string. Use {@link banki.nio.charset.CharsetDecoder} for more control.
     *
     * @throws IndexOutOfBoundsException
     *             if {@code byteCount < 0 || offset < 0 || offset + byteCount > data.length}
     * @throws NullPointerException
...
outer:
     ...
     * system's {@link banki.nio.charset.Charset#defaultCharset default charset}.
     *
     ...
     * is unspecified. Use {@link banki.nio.charset.CharsetEncoder} for more control.
     *
     ...
     * is to replace malformed input and unmappable characters with the charset's default
     * replacement byte array. Use {@link banki.nio.charset.CharsetEncoder} for more control.
     *
     * @since 1.6
     */
     ...
     * within the banki.lang package only.  The caller is responsible for
     ...
     * {@link banki.util.HashMap} to implement their own pools.
     */
    ...
    public String[] split(String regularExpression, int limit) {
        String[] result = banki.util.regex.Splitter.fastSplit(regularExpression, this, limit);
     ...
     *             {@code end > length()}.
     * @see banki.lang.CharSequence#subSequence(int, int)
     * @since 1.4
     */
     ...
     *
     * @param format the format string (see {@link banki.util.Formatter#format})
     * @param args
     ...
     * @throws banki.util.IllegalFormatException
