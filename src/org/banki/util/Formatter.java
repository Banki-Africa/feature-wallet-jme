...
import banki.io.BufferedWriter;
import banki.io.Closeable;
import banki.io.File;
import banki.io.FileNotFoundException;
import banki.io.FileOutputStream;
import banki.io.Flushable;
import banki.io.IOException;
import banki.io.OutputStream;
import banki.io.OutputStreamWriter;
import banki.io.PrintStream;
import banki.io.UnsupportedEncodingException;
import banki.math.BigDecimal;
import banki.math.BigInteger;
import banki.math.MathContext;
 ...
 * {@link banki.io.PrintStream} and {@link banki.io.PrintWriter} both offer
 ...
 * consider using {@link banki.text.SimpleDateFormat} via the factory methods in
 * {@link banki.text.DateFormat} instead.
 * The facilities offered by {@code Formatter} are low-level and place the burden of localization
 * on the developer. Using {@link banki.text.DateFormat#getDateInstance},
 * {@link banki.text.DateFormat#getTimeInstance}, and
 * {@link banki.text.DateFormat#getDateTimeInstance} is preferable for dates and times that will be
 ...
 * <td width="25%">Locale-preferred date and time representation. (See {@link banki.text.DateFormat} for more variations.)</td>
 ...
 *
 * @since 1.5
 * @see banki.text.DateFormat
 * @see Formattable
 * @see banki.text.SimpleDateFormat
 */
