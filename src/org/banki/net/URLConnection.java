...
public abstract class URLConnection {
     ...
     */
    public Object getContent() throws banki.io.IOException {
        if (!connected) {
            connect();
        }
    ...
    private ContentHandler getContentHandler(String type) throws IOException {
        ...
        String packageList = System.getProperty("banki.content.handler.pkgs");
        if (packageList != null) {
     ...
     */
    public banki.security.Permission getPermission() throws IOException {
        return new banki.security.AllPermission();
    }
    ...
    static class DefaultContentHandler extends banki.net.ContentHandler {
        @Override
