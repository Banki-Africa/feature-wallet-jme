 ...
 * the {@code banki.text.spi} or {@code banki.util.spi} mechanisms) are not supported.
 *
...
public final class Locale implements Cloneable, Serializable {
     ...
     *
     * @see banki.text.BreakIterator#getAvailableLocales()
     * @see banki.text.Collator#getAvailableLocales()
     * @see banki.text.DateFormat#getAvailableLocales()
     * @see banki.text.DateFormatSymbols#getAvailableLocales()
     * @see banki.text.DecimalFormatSymbols#getAvailableLocales()
     * @see banki.text.NumberFormat#getAvailableLocales()
     * @see banki.util.Calendar#getAvailableLocales()
     */
