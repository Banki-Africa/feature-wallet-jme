...
public class Object {
     ...
     * {@link banki.io.Closeable}), and insist that callers manually dispose of instances. This
     ...
     * {@link banki.lang.ref.ReferenceQueue} and having your own thread process that queue.
     *
