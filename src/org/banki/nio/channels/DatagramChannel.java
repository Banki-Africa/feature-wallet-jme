...
public abstract class DatagramChannel extends AbstractSelectableChannel
     ...
     *
     * @see banki.nio.channels.SelectableChannel#validOps()
     ...
     * interface.
     *
     * @see banki.nio.channels.ReadableByteChannel#read(banki.nio.ByteBuffer)
     * @param target
     *            the byte buffer to store the received datagram.
     ...
     *
     * @see banki.nio.channels.ScatteringByteChannel#read(banki.nio.ByteBuffer[],
     *      int, int)
     * @param targets
     ...
     *
     * @see banki.nio.channels.WritableByteChannel#write(banki.nio.ByteBuffer)
     * @param source
     ...
     *
     * @see banki.nio.channels.GatheringByteChannel#write(banki.nio.ByteBuffer[],
     *      int, int)
     * @param sources
