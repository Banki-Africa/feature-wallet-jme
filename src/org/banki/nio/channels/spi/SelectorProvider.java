...
import banki.nio.SelectorProviderImpl;
 ...
 * {@link banki.nio.channels.Selector} , {@link ServerSocketChannel}, and
...
public abstract class SelectorProvider {
     ...
     * the first time:
     * <ul>
     * <li> if the system property "banki.nio.channels.spi.SelectorProvider" is
     * set, the value of this property is the class name of the provider
     * returned; </li>
     * <li>if there is a provider-configuration file named
     * "banki.nio.channels.spi.SelectorProvider" in META-INF/services of a jar
