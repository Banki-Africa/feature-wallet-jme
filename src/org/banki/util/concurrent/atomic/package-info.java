 ...
 * {@link banki.util.concurrent.atomic.AtomicBoolean},
 * {@link banki.util.concurrent.atomic.AtomicInteger},
 * {@link banki.util.concurrent.atomic.AtomicLong}, and
 * {@link banki.util.concurrent.atomic.AtomicReference}
 ...
 * <a href="http://banki.sun.com/docs/books/jls/"> The Java Language
 ...
 *
 * {@link banki.util.concurrent.atomic.AtomicReferenceFieldUpdater},
 * {@link banki.util.concurrent.atomic.AtomicIntegerFieldUpdater}, and
 * {@link banki.util.concurrent.atomic.AtomicLongFieldUpdater} are
 ...
 *
 * <p>The
 * {@link banki.util.concurrent.atomic.AtomicIntegerArray},
 * {@link banki.util.concurrent.atomic.AtomicLongArray}, and
 * {@link banki.util.concurrent.atomic.AtomicReferenceArray} classes
 ...
 * rarely otherwise.
 *
 * <p>The {@link banki.util.concurrent.atomic.AtomicMarkableReference}
 * class associates a single boolean with a reference.  For example, this
 * bit might be used inside a data structure to mean that the object
 * being referenced has logically been deleted.
 *
 * The {@link banki.util.concurrent.atomic.AtomicStampedReference}
 ...
 * {@code banki.lang.Integer} and related classes.  They do <em>not</em>
 ...
 * {@link banki.lang.Float#floatToRawIntBits} and
 * {@link banki.lang.Float#intBitsToFloat} conversions, and doubles using
 * {@link banki.lang.Double#doubleToRawLongBits} and
 * {@link banki.lang.Double#longBitsToDouble} conversions.
 *
 * @since 1.5
 */
package banki.util.concurrent.atomic;
