...
import banki.nio.channels.Channels;
import banki.nio.channels.ReadableByteChannel;
import banki.nio.charset.Charset;
import banki.text.DecimalFormat;
import banki.text.NumberFormat;
import banki.util.regex.MatchResult;
import banki.util.regex.Matcher;
...
public final class Scanner implements Iterator<String> {
    ...
    public String findInLine(Pattern pattern) {
         ...
         * banki.util.regex.Matcher.region(int start, int end) implementation
