...
import banki.text.MessageFormat;
import banki.util.ResourceBundle;
...
public abstract class Formatter {
     ...
     * <p>
     * Notice : if message contains "{0", then banki.text.MessageFormat is used.
    ...
    public String formatMessage(LogRecord r) {
        ...
        if (pattern != null) {
            ...
            /*
             * if the message contains "{0", use banki.text.MessageFormat to
             * format the string
             */
