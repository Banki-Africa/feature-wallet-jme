...
import banki.io.NotActiveException;
...
import banki.util.LinkedHashMap;
import banki.util.LinkedHashSet;
...
public abstract class Provider extends Properties {
        ...
        public Object newInstance(Object constructorParameter) throws NoSuchAlgorithmException {
            ...
            try {
                if (type.equalsIgnoreCase("CertStore")) {
                    parameterTypes[0] = Class.forName("banki.security.cert.CertStoreParameters");
                } else {
    ...
    private void readObject(banki.io.ObjectInputStream in)
