...
public abstract class ClassLoader {
     ...
     * banki.lang.System, reproducible when using JDWP with "suspend=y", we defer
    ...
    private static ClassLoader createSystemClassLoader() {
        String classPath = System.getProperty("banki.class.path", ".");
        ...
        // }
        //
        // return new banki.net.URLClassLoader(urls, null);

        // TODO Make this a banki.net.URLClassLoader once we have those?
     ...
     * Basically, the contents of the banki.class.path are searched in order,
     ...
     */
    protected final Class<?> defineClass(String className, byte[] classRep, int offset, int length,
            ProtectionDomain protectionDomain) throws banki.lang.ClassFormatError {
