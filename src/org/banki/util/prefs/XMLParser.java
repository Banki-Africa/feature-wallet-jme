...
class XMLParser {
     ...
     */
    static final String PREFS_DTD_NAME = "http://banki.sun.com/dtd/preferences.dtd";
     ...
     */
    private static final String FILE_PREFS = "<!DOCTYPE map SYSTEM 'http://banki.sun.com/dtd/preferences.dtd'>";
