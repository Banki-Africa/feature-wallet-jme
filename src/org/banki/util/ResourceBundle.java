...
import banki.net.URLConnection;
import banki.nio.charset.Charsets;
import static banki.nio.charset.Charsets.UTF_8;
...
public abstract class ResourceBundle {
    ...
    public static class Control {
        ...
        static String JAVACLASS = "banki.class";

        static String JAVAPROPERTIES = "banki.properties";
         ...
         *            the given locale
         * @param format
         *            the format, default is "banki.class" or "banki.properties"
         * @param loader
