 ...
 * byte sequences.
 *
 * @see banki.io.Serializable
 * @see banki.lang.Comparable
 */
public class File implements Serializable, Comparable<File> {
     ...
     *            which is taken from the "banki.io.tmpdir" system property. It
    ...
    public static File createTempFile(String prefix, String suffix, File directory)
        ...
        if (tmpDirFile == null) {
            String tmpDir = System.getProperty("banki.io.tmpdir", ".");
     ...
     * @throws banki.net.MalformedURLException
     *             if the path cannot be transformed into a URL.
     * @deprecated use {@link #toURI} and {@link banki.net.URI#toURL} to get
     * correct escaping of illegal characters.
     */
    @Deprecated
    public URL toURL() throws banki.net.MalformedURLException {
        String name = getAbsoluteName();
        if (!name.startsWith("/")) {
            // start with sep.
