...
import banki.io.InterruptedIOException;
import banki.net.ConnectException;
import banki.net.DatagramPacket;
import banki.net.DatagramSocket;
import banki.net.DatagramSocketImpl;
import banki.net.InetAddress;
import banki.net.InetSocketAddress;
import banki.net.PlainDatagramSocketImpl;
import banki.net.SocketAddress;
import banki.net.SocketException;
import banki.nio.channels.AlreadyConnectedException;
import banki.nio.channels.ClosedChannelException;
import banki.nio.channels.DatagramChannel;
import banki.nio.channels.IllegalBlockingModeException;
import banki.nio.channels.NotYetConnectedException;
...
/*
 * The default implementation class of banki.nio.channels.DatagramChannel.
 */
class DatagramChannelImpl extends DatagramChannel implements FileDescriptorChannel {
    ...
    /**
     * @see banki.nio.channels.DatagramChannel#isConnected()
     */
    @Override
    ...
    /**
     * @see banki.nio.channels.DatagramChannel#connect(banki.net.SocketAddress)
     */
    @Override
    ...
    /**
     * @see banki.nio.channels.DatagramChannel#disconnect()
     */
    @Override
    ...
    /**
     * @see banki.nio.channels.DatagramChannel#write(banki.nio.ByteBuffer[], int,
     *      int)
     */
    @Override
    ...
    private static class DatagramSocketAdapter extends DatagramSocket {
        ...
        /**
         * @see banki.net.DatagramSocket#isBound()
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#isConnected()
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#getInetAddress()
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#getLocalAddress()
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#getPort()
         */
        @Override
        public int getPort() {
            if (channelImpl.connectAddress == null) {
        ...
        /**
         * @see banki.net.DatagramSocket#bind(banki.net.SocketAddress)
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#receive(banki.net.DatagramPacket)
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#send(banki.net.DatagramPacket)
         */
        @Override
        ...
        /**
         * @see banki.net.DatagramSocket#close()
         */
        @Override
        public void close() {
        ...
        /**
         * @see banki.net.DatagramSocket#disconnect()
         */
        @Override
