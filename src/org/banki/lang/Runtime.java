...
import banki.io.InputStreamReader;
import banki.io.OutputStream;
import banki.io.OutputStreamWriter;
import banki.lang.ref.FinalizerReference;
...
public class Runtime {
     ...
     */
    private Runtime() {
        String pathList = System.getProperty("banki.library.path", ".");
     ...
     */
    public Process exec(String[] progArray) throws banki.io.IOException {
     ...
     *             if the requested program can not be executed.
     */
    public Process exec(String[] progArray, String[] envp) throws banki.io.IOException {
     ...
     *             if the requested program can not be executed.
     */
    public Process exec(String prog) throws banki.io.IOException {
     ...
     *             if the requested program can not be executed.
     */
    public Process exec(String prog, String[] envp) throws banki.io.IOException {
     ...
     *             if the requested program can not be executed.
     */
    public Process exec(String prog, String[] envp, File directory) throws banki.io.IOException {
        // Sanity checks
        if (prog == null) {
