...
import banki.io.Writer;

/**
 * A {@code StreamHandler} object writes log messages to an output stream, that
 * is, objects of the class {@link banki.io.OutputStream}.
 * <p>
 ...
 * <ul>
 * <li>banki.util.logging.StreamHandler.encoding specifies the encoding this
 * handler will use to encode log messages. Default is the encoding used by the
 * current platform.
 * <li>banki.util.logging.StreamHandler.filter specifies the name of the filter
 * class to be associated with this handler. No <code>Filter</code> is used by
 * default.
 * <li>banki.util.logging.StreamHandler.formatter specifies the name of the
 * formatter class to be associated with this handler. Default is
 * {@code banki.util.logging.SimpleFormatter}.
 * <li>banki.util.logging.StreamHandler.level specifies the logging level.
...
public class StreamHandler extends Handler {
    ...
    public StreamHandler() {
        initProperties("INFO", null, "banki.util.logging.SimpleFormatter", null);
        this.os = null;
        this.writer = null;
