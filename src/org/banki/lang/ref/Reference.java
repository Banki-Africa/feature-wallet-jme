 ...
 * {@link banki.lang.ref.SoftReference}, {@link banki.lang.ref.WeakReference}, and
 * {@link banki.lang.ref.PhantomReference}. "Weakness" here means that less restrictions are
 ...
 * instance of a {@code banki.lang.ref.Reference} subclass.
 * </li>
 * </ul> </td>
 * </tr>
 *
 ...
 * a {@code banki.lang.ref.SoftReference} instance, but no {@code banki.lang.ref.WeakReference}
 * or {@code banki.lang.ref.PhantomReference} instances.</li>
 * </ul> </td>
 * </tr>
 *
 * <tr>
 ...
 * {@code banki.lang.ref.WeakReference} instance, but no {@code banki.lang.ref.PhantomReference}
 * instances.</li>
 * </ul> </td>
 * </tr>
 *
 ...
 * <li>The object is referenced by a {@code banki.lang.ref.PhantomReference} instance.</li>
...
public abstract class Reference<T> {
     ...
     * and be a banki.lang.ref.ReferenceQueue.
     */
    volatile ReferenceQueue<? super T> queue;

    /**
     * Used internally by banki.lang.ref.ReferenceQueue.
     * VM requirement: this field <em>must</em> be called "queueNext"
     * and be a banki.lang.ref.Reference.
     */
