...
import banki.net.MalformedURLException;
 ...
 * <pre>{@code
 * <!DOCTYPE preferences SYSTEM "http://banki.sun.com/dtd/preferences.dtd">
 * }</pre>
 ...
 * system property {@code banki.util.prefs.PreferencesFactory} to determine which
