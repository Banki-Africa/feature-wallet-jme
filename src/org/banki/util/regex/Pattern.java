 ...
 * <li>Unicode block names, as used by {@link banki.lang.Character.UnicodeBlock#forName} prefixed
 * by {@code In}. For example {@code \p{InHebrew}} for all characters in the Hebrew block.
 * <li>Character method names. These are all non-deprecated methods from {@link banki.lang.Character}
...
public final class Pattern implements Serializable {
     ...
     *
     * @see Pattern#compile(banki.lang.String, int)
     * @see Matcher#matches()
     */
