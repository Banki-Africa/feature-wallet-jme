 ...
 * <ul>
 * <li>banki.util.logging.FileHandler.append specifies whether this
 * {@code FileHandler} should append onto existing files, defaults to
 * {@code false}.</li>
 * <li>banki.util.logging.FileHandler.count specifies how many output files to
 * rotate, defaults to 1.</li>
 * <li>banki.util.logging.FileHandler.filter specifies the {@code Filter} class
 * name, defaults to no {@code Filter}.</li>
 * <li>banki.util.logging.FileHandler.formatter specifies the {@code Formatter}
 * class, defaults to {@code banki.util.logging.XMLFormatter}.</li>
 * <li>banki.util.logging.FileHandler.encoding specifies the character set
 * encoding name, defaults to the default platform encoding.</li>
 * <li>banki.util.logging.FileHandler.level specifies the level for this
 * {@code Handler}, defaults to {@code Level.ALL}.</li>
 * <li>banki.util.logging.FileHandler.limit specifies the maximum number of
 * bytes to write to any one file, defaults to zero, which means no limit.</li>
 * <li>banki.util.logging.FileHandler.pattern specifies name pattern for the
...
public class FileHandler extends StreamHandler {
    ...
    private void initProperties(String p, Boolean a, Integer l, Integer c) {
        super.initProperties("ALL", null, "banki.util.logging.XMLFormatter",
                null);
    ...
    private String parseFileName(int gen) {
        ...
        String tempPath = System.getProperty("banki.io.tmpdir");
