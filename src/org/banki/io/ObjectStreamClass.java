...
import banki.lang.ref.SoftReference;
...
import banki.lang.reflect.Proxy;
import banki.nio.ByteOrder;
import banki.security.MessageDigest;
import banki.security.NoSuchAlgorithmException;
...
public class ObjectStreamClass implements Serializable {
     ...
     *
     * @param cl
     *            a banki.langClass for which to compute the corresponding
     *            descriptor
     ...
     *            collection of banki.lang.reflect.Field for which to compute
     *            field descriptors
     */
     ...
     *
     * @param cl
     *            a banki.lang.Class for which to compute the SUID
     * @param fields
    ...
    /**
     * Return the banki.lang.reflect.Field {@code serialPersistentFields}
     * if class {@code cl} implements it. Return null otherwise.
     *
     * @param cl
     *            a banki.lang.Class which to test
     * @return {@code banki.lang.reflect.Field} if the class has
    ...
    /**
     * Returns the class (banki.lang.Class) for this descriptor.
     *
     ...
     *
     * @param c
     *            a banki.lang.reflect.Constructor for which to compute the
     *            signature
     ...
     *
     * @param f
     *            a banki.lang.reflect.Field for which to compute the signature
     ...
     *
     * @param m
     *            a banki.lang.reflect.Method for which to compute the signature
     ...
     *
     * @param cl
     *            a banki.lang.Class for which to obtain the corresponding
     *            descriptor
     ...
     *
     * @param cl
     *            a banki.langClass for which to obtain the corresponding
     *            descriptor
    ...
    /**
     * Return the banki.lang.reflect.Method if class <code>cl</code> implements
     * <code>methodName</code> . Return null otherwise.
     *
     * @param cl
     *            a banki.lang.Class which to test
     * @return <code>banki.lang.reflect.Method</code> if the class implements
     ...
     * @param cl
     *            a banki.lang.Class which to test
     * @return {@code banki.lang.reflect.Method} if the class implements
    ...
    /**
     * Set the class (banki.lang.Class) that the receiver represents
     *
     * @param c
