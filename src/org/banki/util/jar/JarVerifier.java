...
package banki.util.jar;

import banki.io.ByteArrayInputStream;
import banki.io.IOException;
import banki.io.OutputStream;
import banki.nio.charset.Charsets;
import banki.security.GeneralSecurityException;
...
class JarVerifier {
     ...
     *
     * @param mf
     *            a {@code banki.util.jar.Manifest} object.
     */
    ...
    /**
     * Returns all of the {@link banki.security.cert.Certificate} instances that
     * were used to verify the signature on the JAR entry called
     * {@code name}.
     *
     * @param name
     *            the name of a JAR entry.
     * @return an array of {@link banki.security.cert.Certificate}.
     */
     ...
     * {@link banki.security.cert.Certificate}s that are associated with the
